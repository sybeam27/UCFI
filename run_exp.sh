# classification
python run_exp.py --task_type classification --dataset_name pokec_z --sens_attr region --remove_leakage --backbone "GraphSAGE" --device cuda:1
...
# regression
python run_exp.py --task_type regression --dataset_name pokec_z --sens_attr region --remove_leakage --backbone "GraphSAGE" --device cuda:1
